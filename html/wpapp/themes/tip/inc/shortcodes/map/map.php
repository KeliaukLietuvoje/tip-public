    ...
    public function tip_map_shortcode($atts)
    {
        $atts = shortcode_atts(
            array(
                ...
                'zoom' => '7',
                'pin' => TIP_THEME_URL . '/assets/images/pin3.svg',
                'pin_size' => '26,38',
                'map_height' => '800px'
            ),
            $atts,
        ...
        $tip_map_js_ver  = date("ymd-His", filemtime(SR_THEME_DIR . '/inc/shortcodes/map/map.js'));
        $tip_map_css_ver  = date("ymd-His", filemtime(SR_THEME_DIR . '/inc/shortcodes/map/map.css'));
