...
{
    wp_register_script('off_canvas_widget', TIP_THEME_URL . '/inc/elementor/widgets/off_canvas/off_canvas_widget.js', [ 'jquery' ], '1.0.0', true);
    wp_register_style('off_canvas_widget', TIP_THEME_URL . '/inc/elementor/widgets/off_canvas/off_canvas_widget.css');
}
